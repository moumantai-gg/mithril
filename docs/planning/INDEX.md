...
| [calibration-1095-live-view-detector](calibration-1095-live-view-detector/) | active | [#1095](https://github.com/moumantai-gg/mithril/issues/1095) | Split projection into durable layer-1 (`world → texture_px` via cal) + lightweight layer-2 (`texture_px → overlay_px` via screenshot-vs-base-texture probe); drop `CalibrationZoom` field + zoom slider + `_session.CurrentMapZoom`; user gestures drive detection, never type zoom |
