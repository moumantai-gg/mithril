...
| [calibration-logging-pass-1093](calibration-logging-pass-1093/) | active | [#1093](https://github.com/moumantai-gg/mithril/issues/1093) | Permanent logging pass over the calibration consumer chain — `PickByFrame`, `AreaCalibrationService` lifecycle, VM projection paths, drawer state transitions, toggle/user-action; new categories + spans + meters matching the AutoCal pattern |
