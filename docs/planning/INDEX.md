...
| [map-calibration-sparse-locate-fallback-1061](map-calibration-sparse-locate-fallback-1061/) | active | [#1061](https://github.com/moumantai-gg/mithril/issues/1061) | Map auto-calibration: Sobel-padded-pyramid `matchTemplate` fallback refiner for sparse-interior maps where ORB+Lowe yields <4 survivors |
