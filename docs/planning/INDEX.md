...
| [calibration-1022-synthesis-rescale](calibration-1022-synthesis-rescale/) | active | [#1022](https://github.com/moumantai-gg/mithril/issues/1022) | Rescale templates inside the synthesis-J L_t field builder — fixes 50–75 s solve regression + mostly-zero fields from #999 |
...
| [map-calibration-1021-per-scene-keying](map-calibration-1021-per-scene-keying/) | active | [#1021](https://github.com/moumantai-gg/mithril/issues/1021) | Calibration keys on literal `Map_<X>` (per-scene) instead of areas.json `AreaX` — unblocks the ~51 aggregator sub-zones autocal can't currently calibrate |
