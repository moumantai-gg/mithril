...
| [map-calibration-blur-aware-template-1070](map-calibration-blur-aware-template-1070/) | shipped | [#1070](https://github.com/moumantai-gg/mithril/issues/1070) | Blur-aware Sobel template for #1061 sparse-locate fallback — closes the NCC-peak-flatness gap that produces Mode-A wall-edge-band registration error in sub-zone interiors |
