...
public class GameWindowPixelTests
{
    [Fact]
    public void TwoArgCtor_DefaultsZToZero()
    {
        var p = new GameWindowPixel(3, 4);
        p.X.Should().Be(3);
        p.Y.Should().Be(4);
        p.Z.Should().Be(0);
    }
    ...
    {
        var p = new GameWindowPixel(3, 4, 5);
        p.X.Should().Be(3);
        p.Y.Should().Be(4);
        p.Z.Should().Be(5);
    }
    ...
    public void Zero_IsOrigin() =>
        GameWindowPixel.Zero.Should().Be(new GameWindowPixel(0, 0, 0));

    [Fact]
    public void DistanceTo_Uses2DMath_IgnoringZ()
    {
        var a = new GameWindowPixel(0, 0, 100);
        var b = new GameWindowPixel(3, 4, -100);
    ...
    {
        var a = new GameWindowPixel(1, 2, 3);
        var b = new GameWindowPixel(1, 2, 3);
        var c = new GameWindowPixel(1, 2, 99);
        a.Should().Be(b);
        a.Should().NotBe(c);
    }
    ...
    {
        IPixelPoint p = new GameWindowPixel(1, 2, 3);
        p.X.Should().Be(1);
        p.Y.Should().Be(2);
        p.Z.Should().Be(3);
    }
